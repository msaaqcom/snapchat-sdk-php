 ...
 */
class CapiEvent implements \JsonSerializable, ArrayAccess, ModelInterface
{
    use CapiEventTrait;
     ...
     * Sets item_ids
     *
     * @param  array|string|null  $item_ids  item_ids
     * @return self
     */
    public function setItemIds(array|string|null $item_ids)
    {
        $this->container['item_ids'] = is_array($item_ids) ? implode(',', $item_ids) : $item_ids;
